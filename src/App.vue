<template>
  ...
  <div class="p-6">
    ...
    <div class="max-w-5xl mt-16 text-darkblue">
      <Section
        title="Over Case Law Explorer"
        text="Case Law Explorer is ontwikkeld door Prof. Dr. Gijs van Dijck, Maastricht Law and Tech Lab en het Brightlands Institute for Smart Society
      ...
      />
      <Section
        title="Wij zoeken ambassadeurs"
        text="Om de Case Law Explorer een stap verder te brengen en het gebruik ervan binnen universiteiten en hogescholen te stimuleren zijn we opzoek naar ambassadeurs. Als ambassadeur heb je enerzijds de
